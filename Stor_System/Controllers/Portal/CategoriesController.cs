...
namespace Stor_System.Controllers.Portal
{
    public class CategoriesController : Controller
    {
        ...
        public CategoriesController(TawerStorContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                string[] Categories_Role_DTL = (HttpContext.Session.GetString("Categories_Role_DTL")).Split(",");
                if (Categories_Role_DTL[0] == "L")
                {
                    return _context.Categories != null ?
                          View(await _context.Categories.ToListAsync()) :
                          Problem("Entity set 'TawerStorContext.Categories'  is null.");
                }
                else
                {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TawerStorContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
